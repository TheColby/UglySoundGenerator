...
pub(super) fn piece(args: PieceArgs) -> Result<()> {
    ...
    let mut options = PieceOptions {
        ...
        section_contrast: args.section_contrast,
    ...
    if let Some(path) = args.manifest.as_ref() {
        let manifest = PieceManifest {
            ...
            planned_event_count: total_events,
            ...
            rest_probability: options.rest_probability,
            section_contrast: options.section_contrast,
            return_probability: options.return_probability,
